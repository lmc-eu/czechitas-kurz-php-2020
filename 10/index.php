...
<p class="text-muted mt-4 mb-4">
    Vítej na blogu: <?php echo $_SESSION['uzivatel']['jmeno']; ?>
</p>
<?php } ?>
...
<ul class="list-unstyled">
    <?php foreach ($clanky as $id => $clanek) { ?>
        <li class="jumbotron pt-2 pb-2 mt-3 mb-1">
            ...
            <span class="small"><?php echo $clanek['autor'] . " | " . date("j.n.Y", strtotime($clanek['datum'])); ?></span>
            <p>
            <?php
                $odrazky = explode("<br />", nl2br($clanek['obsah']));
                echo $odrazky[0];
                if (count($odrazky) > 1) {
                    echo "...";
                }
