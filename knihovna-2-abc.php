    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-1 order-<?php echo $knihovna[0]["cislo"]; ?>">
                ...
                <div class="col-1 order-<?php echo $knihovna[1]["cislo"]; ?>">
                    <div class="container book">
                        <strong>Název</strong>
                ...
                <div class="col-1 order-<?php echo $knihovna[2]["cislo"]; ?>">
                    <div class="container book">
                        <strong>Název</strong>
                ...
                <div class="col-1 order-<?php echo $knihovna[3]["cislo"]; ?>">
                    <div class="container book">
                        <strong>Název</strong>
                ...
                <div class="col-1 order-<?php echo $knihovna[4]["cislo"]; ?>">
                    <div class="container book">
                        <strong>Název</strong>
                ...
                <div class="col-1 order-<?php echo $knihovna[5]["cislo"]; ?>">
                    <div class="container book">
                        <strong>Název</strong>
                ...
                <div class="col-1 order-<?php echo $knihovna[6]["cislo"]; ?>">
                    <div class="container book">
                        <strong>Název</strong>
